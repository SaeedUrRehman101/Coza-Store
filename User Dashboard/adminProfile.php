...
<div class="modal fade" id="exampleModal<?php echo $user['userId'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
